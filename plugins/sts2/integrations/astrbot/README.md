...
一键安装：从 [Releases](https://github.com/sakikoTGW/STS2_Skills/releases/latest) 下载 **`sts2skill.exe`** → 选 **4. AstrBot** → 选择 **AstrBot 数据目录**（如 `%USERPROFILE%\.astrbot\data`）、**游戏目录**、**STS2_Skills 安装目录**。安装程序会解压源码、写入模组、同步插件与 MCP 配置。
